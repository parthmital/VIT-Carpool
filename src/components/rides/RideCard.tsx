...
export function RideCard({ ride }: RideCardProps) {
  ...
  const seatsText = ride.seatsAvailable === 1 ? '1 seat' : `${ride.seatsAvailable} seats`;
          ...
          <div className="flex-1 min-w-0 space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-foreground truncate">{ride.source}</p>
                <p className="text-sm text-muted-foreground truncate mt-2">{ride.destination}</p>
              </div>
            </div>
